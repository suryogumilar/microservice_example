...
import com.sg.pubsub.subscribers.consumer.HelloPubSubConsumer;
...
public class HelloPubSubSubscriberConfig {
	...
	/**
	 * It's called only when the application is ready to receive requests. Passes a
	 * consumer implementation when subscribing to a Pub/Sub topic.
	 */
